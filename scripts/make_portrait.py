...
def generate_ascii_svg(output_path="ascii.svg"):
    ...
    # Remove linhas totalmente vazias do início e do fim
    first_idx = 0
    ...
    lines = raw_lines[first_idx:last_idx + 1]

    # Parâmetros de dimensão e espaçamento proporcional
    font_size = 7
    line_spacing = 8.5
    char_width = 4.3
    ...
    # Intervalo de tempo por linha (25ms para animação mais ágil)
    delay_step = 0.025
